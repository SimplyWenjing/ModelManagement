...
<%
		...
		Student student = new Student(stuId, stuName, Sex, Marriage,
				jiguan, birthday, ruxueTime, teacherName, peiyangStyle,
				yuanxi, major, identify, zhengzhi);
		stuDao.updateStuInfo(student);
		response.sendRedirect("successStuInfoUpdateModel.jsp");
%>
<%
	}
%>
